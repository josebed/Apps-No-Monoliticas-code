...
def registrar_handlers():
    import auditoriaCompania.modulos.auditoria.aplicacion
...
def comenzar_consumidor():
    ...
    import threading
    import auditoriaCompania.modulos.auditoria.infraestructura.consumidores as auditoria
...
def create_app(configuracion={}):
    ...
    # Inicializa la DB
    from auditoriaCompania.config.db import init_db
