...
from propdalpescoleccioncomp.modulos.localizacion.dominio.fabricas import FabricaLocalizaciones
from propdalpescoleccioncomp.modulos.localizacion.infraestructura.fabricas import FabricaRepositorio
from propdalpescoleccioncomp.modulos.localizacion.infraestructura.repositorios import RepositorioLocalizaciones
...
class ServicioLocalizacion(Servicio):
    ...
    def crear_localizacion(self, localizacion_dto: LocalizacionDTO) -> LocalizacionDTO:
        localizacion: Localizacion = self.fabrica_localizaciones.crear_objeto(localizacion_dto, MapeadorLocalizacion())
        # localizacion.crear_reserva(localizacion)

        repositorio = self.fabrica_repositorio.crear_objeto(RepositorioLocalizaciones.__class__)
        ...
        return self.fabrica_localizaciones.crear_objeto(localizacion, MapeadorLocalizacion())

    def obtener_localizacion_por_id(self, id) -> LocalizacionDTO:
        repositorio = self.fabrica_repositorio.crear_objeto(RepositorioLocalizaciones.__class__)
        return self.fabrica_localizaciones.crear_objeto(repositorio.obtener_por_id(id), MapeadorLocalizacion())
