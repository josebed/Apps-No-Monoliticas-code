...
from propdalpescoleccioncomp.modulos.vuelos.aplicacion.dto import ItinerarioDTO, ReservaDTO
...
from propdalpescoleccioncomp.modulos.vuelos.dominio.entidades import Reserva
