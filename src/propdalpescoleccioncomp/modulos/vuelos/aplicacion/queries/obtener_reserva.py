from propdalpescoleccioncomp.seedwork.aplicacion.queries import Query, QueryHandler, QueryResultado
from propdalpescoleccioncomp.seedwork.aplicacion.queries import ejecutar_query as query
from propdalpescoleccioncomp.modulos.vuelos.infraestructura.repositorios import RepositorioReservas
from dataclasses import dataclass
from .base import ReservaQueryBaseHandler
from propdalpescoleccioncomp.modulos.vuelos.aplicacion.mapeadores import MapeadorReserva
import uuid
