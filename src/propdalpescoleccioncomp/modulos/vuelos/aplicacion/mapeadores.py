...
from propdalpescoleccioncomp.modulos.vuelos.dominio.entidades import Reserva, Aeropuerto
from propdalpescoleccioncomp.modulos.vuelos.dominio.objetos_valor import Itinerario, Odo, Segmento, Leg
