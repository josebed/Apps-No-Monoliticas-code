...
from propdalpescoleccioncomp.modulos.vuelos.infraestructura.schema.v1.eventos import EventoReservaCreada
from propdalpescoleccioncomp.modulos.vuelos.infraestructura.schema.v1.comandos import ComandoCrearReserva
