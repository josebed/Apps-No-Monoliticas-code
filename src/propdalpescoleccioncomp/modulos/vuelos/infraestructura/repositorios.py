...
from propdalpescoleccioncomp.modulos.vuelos.dominio.repositorios import RepositorioReservas, RepositorioProveedores
from propdalpescoleccioncomp.modulos.vuelos.dominio.objetos_valor import NombreAero, Odo, Leg, Segmento, Itinerario, CodigoIATA
from propdalpescoleccioncomp.modulos.vuelos.dominio.entidades import Proveedor, Aeropuerto, Reserva
