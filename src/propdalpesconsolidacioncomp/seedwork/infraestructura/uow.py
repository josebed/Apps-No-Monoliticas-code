...
from propdalpesconsolidacioncomp.seedwork.dominio.entidades import AgregacionRaiz
...
def registrar_unidad_de_trabajo(serialized_obj):
    from propdalpesconsolidacioncomp.config.uow import UnidadTrabajoSQLAlchemy
    from flask import session
